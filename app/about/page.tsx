      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="prose prose-lg max-w-none mb-12">
          <p className="text-lg text-neutral-dark mb-6">
            Welcome to Aussie Bitcoin Merchants, your trusted partner in joining Australia's growing Bitcoin economy. We're here to make it simple, secure, and rewarding for small businesses like yours to start accepting Bitcoin payments and connect with a vibrant new community of customers.
          </p>
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-8">
            ...
            <div className="bg-neutral-light p-6 rounded-lg shadow-md">
              ...
              <p className="text-neutral-dark mt-4">
                When he discovered Bitcoin, he recognised those same powerful principles at work. He saw that for Bitcoin to thrive as a day-to-day currency, it needed a robust, open data ecosystem. The project <strong><Link href="https://btcmap.org" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">BTCMap.org</Link></strong>—which plots Bitcoin-friendly merchants on an open map—was the perfect link, connecting his expertise in open data with his passion for Bitcoin.
              </p>
            </div>
          </div>
        </section>
